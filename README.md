...
| **3-Week Wow** | The realistic high-impact scope for **3 engineers in 3 weeks** — a capacity bar (36 man-day capacity · committed · buffer), the wow "moments" grouped by axis (Credibility · Differentiation · Hero · Supporting) each with its deliverables + why-it-wows, a 3-engineer × 3-week swimlane, the deliberately-deferred items (with why-it's-safe + "stage on video" flags), and the critical LLM dependency. Data in `src/model/wow.ts` |
