...
| **Capabilities** | Capability catalogue — **what we support today** (grouped, with "final testing" flags + system integrations) and **what is possible within ~2 weeks**, with count chips. A presentation-focused view of the same `src/model/plan3.ts` data the Delivery Plan uses |
