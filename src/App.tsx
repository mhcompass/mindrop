...
type View = 'posture' | 'readiness' | 'master' | 'tracker' | 'clusters' | 'zoom' | 'agents' | 'checklist' | 'capabilities' | 'plan' | 'deployment';
...
const VIEWS: { id: View; label: string; hint: string }[] = [
  ...
  { id: 'capabilities', label: 'Capabilities', hint: 'What we support today and what is possible within ~2 weeks' },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: theme.app.bg }}>
        <header style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '10px 18px', borderBottom: `1px solid ${theme.app.headerBorder}`, background: theme.app.headerBg, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginLeft: 'auto', flexWrap: 'wrap' }}>
            {view !== 'tracker' && view !== 'clusters' && view !== 'zoom' && view !== 'agents' && view !== 'checklist' && view !== 'plan' && view !== 'capabilities' && LEGEND.map((l) => {
