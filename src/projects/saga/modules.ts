...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    mods: [
      ...
      m('ollama-llm', 'Ollama LLM', 'done', 'done', 'script enhancement · doc gen · LLaVA vision', { owner: 'AI', effort: 'M' }),
      m('tts-service', 'TTS Service', 'done', 'done', 'Piper · Coqui · Kokoro · edge-tts', { owner: 'AI', effort: 'M' }),
  ...
  },
  {
    ...
    mods: [
      ...
      m('tailscale', 'Tailscale Sidecar', 'none', 'none', 'private tailnet HTTPS (saga.<tailnet>.ts.net)', { owner: 'Platform', infra: true }),
    ],
  },
];
